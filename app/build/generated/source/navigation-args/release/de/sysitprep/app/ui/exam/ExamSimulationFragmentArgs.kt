...
public data class ExamSimulationFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ExamSimulationFragmentArgs {
      bundle.setClassLoader(ExamSimulationFragmentArgs::class.java.classLoader)
      ...
      return ExamSimulationFragmentArgs(__sessionType, __fachrichtung, __lernfeld, __examType)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        ExamSimulationFragmentArgs {
      val __sessionType : String?
